...
/** Legacy-style unconditional debug.log line: Info severity, no disk rate limiting (use sparingly). */
#define LogPrintf(...) LogPrintLevel_(BCLog::LogFlags::ALL, BCLog::Level::Info, /*should_ratelimit=*/false, __VA_ARGS__)
