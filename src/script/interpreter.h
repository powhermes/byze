...
public:
    ...
    virtual bool CheckQuantumDualSignature(std::span<const unsigned char> xmss_sig, std::span<const unsigned char> sphincs_sig, std::span<const unsigned char> dual_pubkey, SigVersion sigversion, ScriptExecutionData& execdata, ScriptError* serror = nullptr) const
    {
        return false;
    }
...
protected:
    ...
    virtual bool VerifyQuantumDualSignature(std::span<const unsigned char> xmss_sig, std::span<const unsigned char> sphincs_sig, std::span<const unsigned char> dual_pubkey, const uint256& sighash) const;
...
public:
    ...
    bool CheckQuantumDualSignature(std::span<const unsigned char> xmss_sig, std::span<const unsigned char> sphincs_sig, std::span<const unsigned char> dual_pubkey, SigVersion sigversion, ScriptExecutionData& execdata, ScriptError* serror = nullptr) const override;
...
public:
    ...
    bool CheckQuantumDualSignature(std::span<const unsigned char> xmss_sig, std::span<const unsigned char> sphincs_sig, std::span<const unsigned char> dual_pubkey, SigVersion sigversion, ScriptExecutionData& execdata, ScriptError* serror = nullptr) const override
    {
        return m_checker.CheckQuantumDualSignature(xmss_sig, sphincs_sig, dual_pubkey, sigversion, execdata, serror);
    }
