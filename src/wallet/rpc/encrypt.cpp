...
RPCHelpMan encryptwallet()
{
    return RPCHelpMan{
        ...
        "will require the passphrase to be set prior to making these calls.\n"
                ...
                "** IMPORTANT **\n"
                "Encryption preserves your existing recovery phrase and taproot descriptors.\n"
                "Back up wallet.dat after encrypting.\n",
                {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    return "Wallet encrypted successfully. The existing recovery phrase remains valid. Back up wallet.dat after encryption.";
},
    };
}
} // namespace wallet
