...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            const bool is_quantum_address = isValid && std::holds_alternative<WitnessV1Taproot>(dest);
            ret.pushKV("isvalid", is_quantum_address);
            if (is_quantum_address) {
                ...
                if (isValid && !is_quantum_address && error_msg.empty()) {
                    error_msg = "Legacy address type is disabled; use bech32m witness v1";
                }
