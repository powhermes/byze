...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock()
{
    ...
    // Initialize quantum-safe signature structure (signatures will be added after mining)
    // The signatures are part of the block but not part of the PoW hash
    pblock->quantum_signatures.SetNull();
