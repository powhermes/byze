...
void ReceiveCoinsDialog::setModel(WalletModel *_model)
{
    ...
    if(_model && _model->getOptionsModel())
    {
        ...
        // Byze uses only bech32m witness-v1 quantum addresses.
        ui->addressType->clear();
        const auto index = ui->addressType->count();
        ui->addressType->addItem(tr("Bech32m (Quantum)"), (int)OutputType::BECH32M);
        ui->addressType->setItemData(index, tr("Byze quantum-safe address format."), Qt::ToolTipRole);
