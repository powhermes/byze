...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Byze address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and byze: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Byze addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Byze addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Byze Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Byze Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a byze: URI"));
...
void BitcoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        if (optionsModel) {
            GUIUtil::SetDarkTheme(optionsModel->getDarkMode());
            connect(optionsModel, &OptionsModel::darkModeChanged, this, [](bool enabled) {
                GUIUtil::SetDarkTheme(enabled);
            });
        }
    } else {
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Byze network.", "", count);
    } else {
        //: A substring of the tooltip.
