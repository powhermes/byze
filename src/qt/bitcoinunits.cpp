...
{
    switch (unit) {
    case Unit::BTC: return QString("BYZ");
    case Unit::mBTC: return QString("mBYZ");
    case Unit::uBTC: return QString::fromUtf8("µBYZ");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Byze");
    case Unit::mBTC: return QString("Milli-Byze (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Byze (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
