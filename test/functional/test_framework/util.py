...
def get_binary_paths(config):
    ...
    binaries = {
        ...
        "byzed": "BITCOIND",
        "byze-cli": "BITCOINCLI",
        "byze-util": "BITCOINUTIL",
        "byze-tx": "BITCOINTX",
        "byze-chainstate": "BITCOINCHAINSTATE",
        "byze-wallet": "BITCOINWALLET",
    }
    # Set paths to Byze binaries allowing overrides with environment
    # variables.
...
def initialize_datadir(dirname, n, chain, disable_autoconnect=True):
    ...
    if not os.path.isdir(datadir):
        os.makedirs(datadir)
    write_config(os.path.join(datadir, "byze.conf"), n=n, chain=chain, disable_autoconnect=disable_autoconnect)
...
def append_config(datadir, options):
    with open(os.path.join(datadir, "byze.conf"), 'a') as f:
...
def get_auth_cookie(datadir, chain):
    user = None
    password = None
    if os.path.isfile(os.path.join(datadir, "byze.conf")):
        with open(os.path.join(datadir, "byze.conf"), 'r') as f:
            for line in f:
